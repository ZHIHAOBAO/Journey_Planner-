...
public abstract class RoutingResource { 
    ...
    /** An list of modes to be used between intermediate locations. Element 0 is mode point A to B, 1 is B to C ect. */
    @QueryParam("intermediateModes")
    protected List<QualifiedModeSet> intermediateModes;
