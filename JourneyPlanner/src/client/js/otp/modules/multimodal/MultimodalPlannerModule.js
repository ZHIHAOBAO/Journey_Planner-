...
otp.modules.multimodal.MultimodalPlannerModule =
    ...
    activate : function() {
        ...
        this.optionsWidget.addControl("myFavourite", new otp.widgets.tripoptions.MyFavorite(this.optionsWidget), true);
        ...
        modeSelector.addModeControl(new otp.widgets.tripoptions.SortBySelector(this.optionsWidget));
    ...
    routesLoaded : function() {
        ...
        this.shareToWidget = new otp.widgets.transit.ShareToWidget("otp-"+this.id+"-shareToWidget", this);
        this.shareToWidget.center();
        
        this.markLocationWidgt = new otp.widgets.transit.MarkLocationWidget("otp-"+this.id+"-markLocationWidget", this);
        this.markLocationWidgt.center();
        
        this.distanceWidgt = new otp.widgets.transit.DistanceWidget("otp-"+this.id+"-distanceWidget", this);
        this.distanceWidgt.center();
    ...
    processPlan : function(tripPlan, restoring) {
        ...
        for(var i=0; i < tripPlan.itineraries.length; i++) {
            this.drawItinerary(tripPlan.itineraries[i], i !== 0);        	
        }
    },
