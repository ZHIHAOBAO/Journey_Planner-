...
var IntermediateFlagIcon = L.Icon.extend({
    options: {
        iconUrl: resourcePath + 'images/marker-flag-intermediate.png',
        shadowUrl: null,
...
var MediumRedIcon = L.Icon.extend({
    options: {
        iconUrl: resourcePath + 'images/marker-red-med.png',
        shadowUrl: null,
        iconSize: new L.Point(13, 23),
        iconAnchor: new L.Point(7, 23),
        popupAnchor: new L.Point(0, -23)
...
var MediumGreenIcon = L.Icon.extend({
    options: {
        iconUrl: resourcePath + 'images/marker-green-med.png',
        shadowUrl: null,
        iconSize: new L.Point(13, 23),
        iconAnchor: new L.Point(7, 23),
        popupAnchor: new L.Point(0, -23)
...
var MediumParkIcon = L.Icon.extend({
    options: {
        iconUrl: resourcePath + 'images/marker-park-med.png',
        shadowUrl: null,
        iconSize: new L.Point(13, 23),
        iconAnchor: new L.Point(7, 23),
        popupAnchor: new L.Point(0, -23)
...
otp.modules.planner.IconFactory = otp.Class({
    ...
    intermediateFlag : new IntermediateFlagIcon(),
    ...
    mediumRed  : new MediumRedIcon(),
    mediumGreen  : new MediumGreenIcon(),
